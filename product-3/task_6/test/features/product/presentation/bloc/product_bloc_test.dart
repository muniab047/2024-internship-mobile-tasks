...
void main() {
  ...
  group('insert Product', () {
    ...
    blocTest<ProductBloc, ProductState>(
        ...
        expect: () => {
              Waiting(),
              InsertSuccessState(message: 'product inserted successfully')
            });
   ...
   group('update Product', () {
    ...
    blocTest<ProductBloc, ProductState>(
        ...
        expect: () => {
              Waiting(),
              UpdateSuccessState(message: 'product updated successfully')
            });
   ...
   group('delete Product', () {
    ...
    blocTest<ProductBloc, ProductState>(
        ...
        expect: () => {
              Loading(),
              DeleteSuccessState(message: 'product deleted successfully')
            });
