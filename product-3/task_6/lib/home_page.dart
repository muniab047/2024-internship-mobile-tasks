              ...
              children: [
                Row(
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.all(Radius.circular(ratio(10))),
                          border: Border.all(color: Color(0XFFD9D9D9),
                          )
                        ),
                        child: IconButton(
                          onPressed: null,
                          icon : Icon(Icons.search_outlined, size: ratio(30),),
                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return card(image: image,item: item, price: price, product: name, rating: rating,);
                    },),
                )
                ],
            )),
